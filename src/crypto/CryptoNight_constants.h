...
constexpr const size_t   CRYPTONIGHT_UPX_MEMORY  = 2 * 1024 * 1024;
constexpr const uint32_t CRYPTONIGHT_UPX_MASK    = 0x1FFFF0;
constexpr const uint32_t CRYPTONIGHT_UPX_ITER    = 0x4000;
